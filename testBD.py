...
def agregarCiudades(ciudadDAO):
    ...
    if ciudadDAO.traerCiudades() == []:
        ...
        lstC.append(Ciudad(nombre="Rosario",        latitud="-32.9468200", longitud="-60.6393200"))
        lstC.append(Ciudad(nombre="Mendoza",        latitud="-32.8908400", longitud="-68.8271700"))
        lstC.append(Ciudad(nombre="Tucuman",        latitud="-26.8241400", longitud="-65.2226000"))
        lstC.append(Ciudad(nombre="La Plata",       latitud="-34.9214500", longitud="-57.9545300"))
        lstC.append(Ciudad(nombre="Mar del Plata",  latitud="-38.0022800", longitud="-57.5575400"))
        lstC.append(Ciudad(nombre="Quilmes",        latitud="-34.7241800", longitud="-58.2526500"))
        lstC.append(Ciudad(nombre="Arequito",       latitud="-33.1453000", longitud="-61.4666666"))
        lstC.append(Ciudad(nombre="Salta",          latitud="-24.7859000", longitud="-65.4116600"))
        lstC.append(Ciudad(nombre="Neuquen",        latitud="-38.9516100", longitud="-68.0591000"))
...
def agregarPasajes(pasajeDAO):
    ...
    lstP.append(Pasaje(fecha=datetime.date(2019, 4, 13), pasajero=5, origen=1, destino=2, formaPago="dinero"))
    lstP.append(Pasaje(fecha=datetime.date(2019, 4, 13), pasajero=5, origen=1, destino=3, formaPago="dinero"))
    lstP.append(Pasaje(fecha=datetime.date(2019, 4, 13), pasajero=5, origen=2, destino=3, formaPago="dinero"))
    lstP.append(Pasaje(fecha=datetime.date(2019, 4, 20), pasajero=1, origen=2, destino=3, formaPago="dinero"))
